...
qqApp.controller("userFormController", function($scope, $location, sessionStorageService, serverComunicationService) {
    ...
    if(sessionStorageService.isLoggedIn()){
        ...
        currentUser = sessionStorageService.getLoggedUser();
